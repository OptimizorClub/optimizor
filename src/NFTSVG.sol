...
library NFTSVG {
        ...
        returns (string memory svg)
    {
        ...
        svg = string.concat(
            ...
            '<text x="12px" y="17px"><tspan fill="rgba(255,255,255,0.6)">ID: </tspan>',
            tokenId,
            "</text></g>",
            ...
            'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)"/>',
            '<text x="12px" y="17px"><tspan fill="rgba(255,255,255,0.6)">Gas used: </tspan>',
            gasUsedStr,
            "</text></g>",
            ...
            'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)"/>',
            '<text x="12px" y="17px"><tspan fill="rgba(255,255,255,0.6)">Gas opti: </tspan>',
            gasOptiStr,
            "%",
            "</text></g></g>"
        );
